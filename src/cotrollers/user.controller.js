...
const getUserChannelProfile = asyncHandler(async (req,res)=>{
    ...
    return res.
    status(200)
    .json(new ApiRespose(200,channel[0],"User channel fetched sucessfully"));
...
const getWatchHistory = asyncHandler(async (req,res)=>{
    ...
    return res.status(200).json(new ApiRespose(200,user[0].watchHistory,"User watch history fetched sucessfully"))
})
